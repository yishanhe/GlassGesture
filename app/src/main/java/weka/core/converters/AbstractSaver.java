...
public abstract class AbstractSaver
   ...
   * @throws java.io.IOException IOEXception if the instance acnnot be written to the specified destination
   */  
   ...
   * To be overridden.
   * @throws java.io.IOException exception if writting is not possible
   */  
