...
public interface Saver
   ...
   * @exception java.io.IOException if this Loader doesn't
   * support loading from a File.
   */
   ...
   * @throws java.io.IOException exception if new output file cannot be set
   */  
   ...
   * @throws java.io.IOException exception if a Saver not implementing FileSourcedConverter is used.
   */  
   ...
   * @throws java.io.IOException throws exection if writting in batch mode is not possible
   */  
   ...
   * @throws java.io.IOException throws exception if incremental writting is not possible
   */  
