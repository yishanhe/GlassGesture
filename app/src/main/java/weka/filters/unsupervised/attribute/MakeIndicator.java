...
public class MakeIndicator 
   ...
   * @throws weka.core.UnsupportedAttributeTypeException the selecte attribute is not nominal
   * @throws weka.core.UnsupportedAttributeTypeException the selecte attribute has fewer than two values.
   */
